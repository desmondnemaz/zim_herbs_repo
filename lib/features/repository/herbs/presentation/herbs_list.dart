...
class _HerbsListState extends State<HerbsList> {
  ...
  void _handleDelete(BuildContext context, Herb herb) async {
  ...
  Widget build(BuildContext context) {
    ...
    return Builder(
      builder: (context) {
        ...
        final currentBlocState = context.read<HerbCubit>().state;
                  ...
                  child: Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        // HERBS LIST
                        Expanded(
                          child: BlocBuilder<HerbCubit, HerbState>(
                            builder: (context, state) {
    ...
    return Padding(
      ...
      child: TextField(
        onChanged: (value) {
          ...
          context.read<HerbCubit>().searchHerbs(value);
        },
