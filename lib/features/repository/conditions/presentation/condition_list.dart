...
import 'package:zim_herbs_repo/features/repository/conditions/bloc/condition_bloc.dart';
import 'package:zim_herbs_repo/features/repository/conditions/bloc/condition_event.dart';
import 'package:zim_herbs_repo/features/repository/conditions/bloc/condition_state.dart';
...
class _ConditionsListPageState extends State<ConditionsListPage> {
  // We no longer need the repository here!
  ...
  Future<void> _handleDelete(
    ...
    if (confirm == true && context.mounted) {
      context.read<ConditionBloc>().add(DeleteCondition(condition.id));
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create:
          (context) =>
              ConditionBloc(ConditionRepository())..add(LoadConditions()),
      child: BlocListener<ConditionBloc, ConditionState>(
