                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (Responsive.isMobile(context)) ...[
                        _buildNameHeader(widget.product.name, colorScheme, rs),
                      ...
                      _buildSectionCard(
                        ...
                        content: Column(
                          ...
                          children: [
                            ...
                            Text(
                              "This high-quality ${widget.product.name} is sourced directly from traditional growers in Zimbabwe. It is carefully processed to retain all its natural medicinal properties and nutrients. Perfect for daily use and traditional remedies.",
                              style: TextStyle(
                                color: colorScheme.onSurfaceVariant,
                                height: 1.6,
                                fontSize: 15,
                      ...
                      _buildSectionCard(
                        ...
                        content: Column(
                          ...
                          children: [
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        const SizedBox(width: 4),
                                        Text(
                                          widget.product.supplierLocation,
                                          style: TextStyle(
                                            fontSize: 13,
                                            color: colorScheme.onSurfaceVariant,
                                          ),
                            ...
                            const SizedBox(height: 4),
                            Text(
                              "A trusted local partner specializing in sustainable harvesting and traditional processing methods in the ${widget.product.supplierLocation.split(',')[0]} region.",
                              style: TextStyle(
                                color: colorScheme.onSurfaceVariant,
                                height: 1.4,
                                fontSize: 13,
